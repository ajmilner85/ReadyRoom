  ...
  return (
    <div style={{ ...dossierStyles.card, flexShrink: 0 }}>
      ...
      <div style={{ ...dossierStyles.cardContent, display: 'flex', flexDirection: 'column', overflowY: 'visible', minHeight: '200px' }}>
        ...
        {loading ? (
          <div style={dossierStyles.emptyState}>Loading trap records...</div>
        ) : filteredTraps.length === 0 ? (
          <div style={{ ...dossierStyles.emptyState, flexDirection: 'column', gap: '8px' }}>
...
export default DossierTrapSheetCard;
