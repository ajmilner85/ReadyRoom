...
interface SortableStandingRowProps {
  standing: Standing;
  onEditClick: () => void;
  onDeleteClick: () => void;
...
export const SortableStandingRow: React.FC<SortableStandingRowProps> = ({
  standing,
  onEditClick,
  onDeleteClick,
  standingUsage
        ...
        {isHovered && (
          <>
            ...
            <button
              ...
              title={standingUsage[standing.id] > 0 ? "Cannot delete a standing in use" : "Delete standing"}
              onMouseEnter={(e) => {
